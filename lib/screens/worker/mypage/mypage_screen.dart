...
class MyPageScreen extends StatefulWidget {
  ...
  const MyPageScreen({super.key, required this.appType, this.meRepository});
...
class _MyPageScreenState extends State<MyPageScreen> {
  ...
  void initState() {
    super.initState();
    _repo = widget.meRepository ?? MeRepository.fromApi();
    _future = _repo.getMe();
  }
